    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-white p-8 rounded-md shadow-md w-full max-w-md">
        ...
        <div className="mt-4 text-center">
          <p className="text-sm">
            Don't have an account? <a href="/register" className="text-blue-500 font-bold">Register</a>
          </p>
          <p className="text-sm">
            <a href="/forgot-password" className="text-blue-500 font-bold">Forgot Password?</a>
          </p>
        </div>
      </div>
    </div>
